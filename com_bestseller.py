...
for pgNo in range(1,6):
	url="https://www.amazon.com/gp/bestsellers/books/ref=zg_bs_pg_{}?ie=UTF8&pg={}".format(pgNo,pgNo)
	...
	for i in soup1:
		...
		try:
	 		book_url="https://www.amazon.com"+(i.find("a",{"class":"a-link-normal"}))['href']
		except:
		...
		try:
	 		book_price=(i.find("span",{"class":"p13n-sc-price"}).text).strip()
		except:
